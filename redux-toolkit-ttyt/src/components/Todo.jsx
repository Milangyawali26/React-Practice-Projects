...
export const Todo = () => {
  ...
  return (
    <div className="bg-amber-100 h-screen">
      <h1 className="flex justify-center items-center text-3xl font-medium">To-Do List:</h1>
      ...
      <div className="flex justify-center items-center bg-gray-200 py-5">
        <div className="w-full max-w-md h-100 overflow-y-auto">
          <ul>
            {tasks.length === 0 ? (
              ...
              tasks?.map((currTask,index) => (
                <li
                  key={currTask.id}
                  className="flex justify-between items-center bg-white px-4 py-2 my-2 rounded-md shadow-md shadow-amber-300"
                >
                  ...
                  <div className="relative group">
                    <div className="bg-red-400 rounded-lg hover:cursor-pointer hover:bg-red-600 hover:text-white p-2 text-2xl">
                      <MdDeleteForever onClick={() => handleTaskDelete(currTask.id)} />
                    </div>
                  </div>
                </li>
              ))
